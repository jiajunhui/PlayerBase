...
public class DecoderTypeEntity implements Serializable {
    ...
    public DecoderTypeEntity(String decoderName, String decoderClassPath) {
        this.decoderName = decoderName;
        this.decoderClassPath = decoderClassPath;
    }
    ...
    public String getDecoderClassPath() {
        return decoderClassPath;
    }

    public void setDecoderClassPath(String decoderClassPath) {
        this.decoderClassPath = decoderClassPath;
    }
}
