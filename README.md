...
dependencies {
  ...
  //该依赖仅包含MediaPlayer解码
  implementation 'com.kk.taurus.playerbase:playerbase:3.3.4.2'
  
  
  //---------如果使用ExoPlayer解码，使用以下依赖。---------
  //该依赖包含exoplayer解码和MediaPlayer解码
  //注意exoplayer的最小支持SDK版本为16
  implementation 'cn.jiajunhui:exoplayer:3342_291_008'

  
  //---------如果使用ijkPlayer解码，使用以下依赖。---------
  //该依赖包含ijkplayer解码和MediaPlayer解码
  implementation 'cn.jiajunhui:ijkplayer:3342_088_006'
