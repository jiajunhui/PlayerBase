...
import com.taurus.playerbaselibrary.holder.OutlineHolder;

/**
 * Created by Taurus on 2017/12/9.
 */

public class OutlineFragment extends StateFragment<HolderData,OutlineHolder> {

    @Override
    public ContentHolder onBindContentHolder() {
        return new OutlineHolder(mContext,this);
    }
